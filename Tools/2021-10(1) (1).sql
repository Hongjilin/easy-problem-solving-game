...
CREATE TABLE `io_points` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT=' IO 知识点情况表 (io_points)';
...
INSERT INTO `io_points` VALUES (1,'1701130050',10,20,10,10,10,10,'json假数据'),(2,'1701130082',11,22,11,11,11,11,'json假数据'),(3,'1701130096',33,33,33,33,33,33,'json假数据'),(4,'170113003',44,44,55,65,78,87,'士大夫');
...
INSERT INTO `thread_points` VALUES (1,'1701130050',11,11,11,11,'json假数据'),(2,'1701130082',22,22,22,22,'json假数据');
...
CREATE TABLE `thread_scorecard` (
  ...
  `elapsed` int(11) DEFAULT '0' COMMENT '记录时间:消耗的秒数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='线程通信分数表 ( thread_score): 主要做线程通信游戏分数排行榜';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `thread_scorecard` VALUES (1,'1701130050','努力学习的汪',88,200),(2,'1701130082','尧',66,500),(3,'1701130089','帅哥',88,500);
...
INSERT INTO `user` VALUES (1701130050,'努力学习的汪','123456',1),(1701130051,'攀','123456',2),(1701130082,'尧','123456',1);
...
-- Dump completed on 2021-11-10 18:31:35
